...
Present your brainstormed names in a hyphenated list labeled `Name Idea 1`, `Name Idea 2`, etc., inside `<brainstorming>` tags.
...
<results>
- Rank 1: [Best Name Idea]
- Rank 2: [Second Best Name Idea]
- Rank 3: [Third Best Name Idea]
</results>
