...
# Core Objectives
- Design a tightly paced, [Duration]-minute transcript balancing depth and entertainment.
- Seamlessly integrate 3-5 focusing points into a natural, unforced arc (e.g., tension → revelation → resolution).
- Embed channel-specific branding through tone ([specify: witty/professional/quirky]), inside jokes, and recurring segment callbacks.
